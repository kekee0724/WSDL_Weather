 ...
 */
    ...
    public WeatherWebServiceSoap getWeatherWebServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public WeatherWebServiceSoap getWeatherWebServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            WeatherWebServiceSoapStub _stub = new WeatherWebServiceSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (WeatherWebServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                WeatherWebServiceSoapStub _stub = new WeatherWebServiceSoapStub(new java.net.URL(WeatherWebServiceSoap_address), this);
                _stub.setPortName(getWeatherWebServiceSoapWSDDServiceName());
                return _stub;
            }
        }
